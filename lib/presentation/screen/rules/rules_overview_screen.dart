...
import 'package:scrollrole/presentation/screen/rules/overview/rules_body.dart';
import 'package:scrollrole/util/dialog_util.dart';
import 'package:scrollrole/util/snackbar_util.dart';

class RulesOverviewScreen extends StatelessWidget {
  ...
  static GoRoute route() {
    return GoRoute(
      ...
      builder: (BuildContext context, GoRouterState state) {
        return const RulesOverviewScreen();
      },
    );
  }

  const RulesOverviewScreen({super.key});
